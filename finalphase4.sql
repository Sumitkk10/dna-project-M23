...
INSERT INTO `AlbumCover` VALUES (1,'2023-01-01'),(2,'2023-02-05'),(3,'2023-03-10'),(4,'2023-04-15'),(5,'2023-05-20'),(6,'2023-07-03'),(7,'2023-07-30'),(8,'2023-08-04'),(9,'2023-09-09'),(10,'2023-10-14');
...
CREATE TABLE `ArtistPhoneNumbers` (
  ...
  CONSTRAINT `ArtistPhoneNumbers_ibfk_2` FOREIGN KEY (`artist_id`) REFERENCES `Artists` (`artist_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ArtistPhoneNumbers` VALUES (301,1234567890),(302,2345678901),(303,3456789012),(304,4567890123),(305,5678901234),(306,6789012345),(307,7890123456),(308,8901234567),(309,9012345678);
...
INSERT INTO `Artists` VALUES (301,1,101,'Adele','2008-06-20',5,'1988-05-05',201,401),(302,2,102,'Ed Sheeran','2011-08-26',7,'1991-02-17',202,402),(303,3,103,'Beyoncé','2003-09-04',6,'1981-09-04',203,403),(304,4,104,'Justin Bieber','2008-01-15',9,'1994-03-01',204,404),(305,5,105,'Taylor Swift','2006-10-24',10,'1989-12-13',205,405),(306,6,106,'Bruno Mars','2010-10-04',6,'1985-10-08',206,401),(307,7,107,'Ariana Grande','2008-12-01',8,'1993-06-26',207,402),(308,8,108,'Drake','2006-06-15',9,'1986-10-24',208,403),(309,9,109,'Rihanna','2005-03-08',8,'1988-02-20',209,404),(311,10,110,'John Doe','2022-01-01',3,'1990-05-15',210,405);
...
INSERT INTO `ChartPosition` VALUES (101,1),(102,2),(103,3),(104,4),(105,20),(106,6),(107,7),(108,8),(109,9),(110,10),(500,12);
...
CREATE TABLE `Designers` (
  ...
  CONSTRAINT `Designers_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `EmployeeInfo` (`employee_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Genre` VALUES (101,'Pop'),(102,'Rock'),(103,'Hip-Hop'),(104,'Indie'),(105,'Electronic'),(106,'Jazz'),(107,'Country'),(108,'R&B'),(109,'Reggae'),(110,'Classical'),(500,'Jazz');
/*!40000 ALTER TABLE `Genre` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Genre_Artists`
--
...
--
-- Dumping data for table `Genre_Artists`
--

LOCK TABLES `Genre_Artists` WRITE;
/*!40000 ALTER TABLE `Genre_Artists` DISABLE KEYS */;
INSERT INTO `Genre_Artists` VALUES ('Taylor Swift','Pop'),('The Rolling Stones','Rock'),('Kendrick Lamar','Hip-Hop'),('Tame Impala','Indie'),('Daft Punk','Electronic'),('John Coltrane','Jazz'),('Johnny Cash','Country'),('Beyoncé','R&B'),('Bob Marley','Reggae'),('Ludwig van Beethoven','Classical'),('Miles Davis','Jazz'),('Ariana Grande','Pop'),('Led Zeppelin','Rock'),('Drake','Hip-Hop'),('Arctic Monkeys','Indie'),('Calvin Harris','Electronic'),('Ella Fitzgerald','Jazz'),('Dolly Parton','Country'),('Frank Ocean','R&B'),('Bob Marley','Reggae'),('Wolfgang Amadeus Mozart','Classical'),('Louis Armstrong','Jazz'),('Ed Sheeran','Pop'),('Queen','Rock'),('Jay-Z','Hip-Hop'),('Radiohead','Indie'),('Avicii','Electronic'),('Nina Simone','Jazz'),('Shania Twain','Country'),('Usher','R&B'),('Ziggy Marley','Reggae'),('Ludwig van Beethoven','Classical'),('Ella Fitzgerald','Jazz'),('Lady Gaga','Pop'),('Coldplay','Rock'),('Eminem','Hip-Hop'),('Florence + The Machine','Indie'),('Kygo','Electronic'),('Charlie Parker','Jazz'),('Johnny Cash','Country'),('Rihanna','R&B'),('Sean Paul','Reggae'),('Johann Sebastian Bach','Classical'),('Diana Krall','Jazz');
/*!40000 ALTER TABLE `Genre_Artists` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Managers` (
  ...
  CONSTRAINT `Managers_ibfk_4` FOREIGN KEY (`manager_id`) REFERENCES `EmployeeInfo` (`employee_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Managers` VALUES (226,101),(227,102),(228,103),(229,104);
...
CREATE TABLE `Producers` (
  ...
  CONSTRAINT `Producers_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `EmployeeInfo` (`employee_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `SongWriters` (
  ...
  CONSTRAINT `SongWriters_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `EmployeeInfo` (`employee_id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `TourAddresses` VALUES (1,10001),(2,90001),(3,37201),(4,98101),(5,33101),(6,30301),(7,70112),(8,60601),(9,94101),(10,73301),(500,500021);
...
INSERT INTO `TourDates` VALUES (1,'2023-05-01','2023-05-15'),(2,'2023-06-01','2023-06-20'),(3,'2023-07-01','2023-07-10'),(4,'2023-08-01','2023-08-15'),(5,'2023-09-01','2023-09-25'),(6,'2023-10-01','2023-10-18'),(7,'2023-11-01','2023-11-10'),(8,'2023-12-01','2023-12-20'),(9,'2024-01-01','2024-01-15'),(10,'2024-02-01','2024-02-18'),(500,'2010-10-10','2010-10-30');
...
INSERT INTO `TourLocations` VALUES (1,'New York','NY'),(2,'Los Angeles','CA'),(3,'Nashville','TN'),(4,'Seattle','WA'),(5,'Miami','FL'),(6,'Atlanta','GA'),(7,'New Orleans','LA'),(8,'Chicago','IL'),(9,'San Francisco','CA'),(10,'Austin','TX'),(500,'Jalandhar','JRC');
...
-- Dump completed on 2023-12-03 18:50:57
